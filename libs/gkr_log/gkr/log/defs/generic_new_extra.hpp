...
#error  You cannot include this header directly - ensure LOG_FACILITY and LOG_CPP_LEGACY are both not defined (and C++ if constexpr must be available) and then include "generic.hpp" 
#endif
...
inline void  LOG   (                                int severity, int facility, const char* msg) { gkr::log::simple_message_rts   (           LOG_INSTANCE, severity, facility, msg); }
inline void  LOG_IF(bool condition,                 int severity, int facility, const char* msg) { gkr::log::simple_message_rts_if(condition, LOG_INSTANCE, severity, facility, msg); }
inline void CLOG   (                void* instance, int severity, int facility, const char* msg) { gkr::log::simple_message_rts   (               instance, severity, facility, msg); }
inline void CLOG_IF(bool condition, void* instance, int severity, int facility, const char* msg) { gkr::log::simple_message_rts_if(condition,     instance, severity, facility, msg); }
...
template<typename... Args> void LOG_    (                                int severity, int facility, const char* format, Args&&... args) { gkr::log::printf_message_rts   (           LOG_INSTANCE, severity, facility, format, std::forward<Args>(args)...); }
template<typename... Args> void LOG_IF_ (bool condition,                 int severity, int facility, const char* format, Args&&... args) { gkr::log::printf_message_rts_if(condition, LOG_INSTANCE, severity, facility, format, std::forward<Args>(args)...); }
template<typename... Args> void CLOG_   (                void* instance, int severity, int facility, const char* format, Args&&... args) { gkr::log::printf_message_rts   (               instance, severity, facility, format, std::forward<Args>(args)...); }
template<typename... Args> void CLOG_IF_(bool condition, void* instance, int severity, int facility, const char* format, Args&&... args) { gkr::log::printf_message_rts_if(condition,     instance, severity, facility, format, std::forward<Args>(args)...); }
...
inline auto CLOGF       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_FATAL  >(instance, facility); }
inline auto CLOGE       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_ERROR  >(instance, facility); }
inline auto CLOGW       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_WARNING>(instance, facility); }
inline auto CLOGI       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_INFO   >(instance, facility); }
inline auto CLOGV       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_VERBOSE>(instance, facility); }
inline auto CLOGD       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_DEBUG  >(instance, facility); }
inline auto CLOGT       (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_TRACE  >(instance, facility); }

inline auto CLOG_FATAL  (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_FATAL  >(instance, facility); }
inline auto CLOG_ERROR  (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_ERROR  >(instance, facility); }
inline auto CLOG_WARNING(void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_WARNING>(instance, facility); }
inline auto CLOG_INFO   (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_INFO   >(instance, facility); }
inline auto CLOG_VERBOSE(void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_VERBOSE>(instance, facility); }
inline auto CLOG_DEBUG  (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_DEBUG  >(instance, facility); }
inline auto CLOG_TRACE  (void* instance, int facility) { return gkr::log::stream_message<LOG_SEVERITY_TRACE  >(instance, facility); }

inline auto CLOGF_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_FATAL  >(condition, instance, facility); }
inline auto CLOGE_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_ERROR  >(condition, instance, facility); }
inline auto CLOGW_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_WARNING>(condition, instance, facility); }
inline auto CLOGI_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_INFO   >(condition, instance, facility); }
inline auto CLOGV_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_VERBOSE>(condition, instance, facility); }
inline auto CLOGD_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_DEBUG  >(condition, instance, facility); }
inline auto CLOGT_IF        (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_TRACE  >(condition, instance, facility); }

inline auto CLOG_FATAL_IF   (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_FATAL  >(condition, instance, facility); }
inline auto CLOG_ERROR_IF   (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_ERROR  >(condition, instance, facility); }
inline auto CLOG_WARNING_IF (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_WARNING>(condition, instance, facility); }
inline auto CLOG_INFO_IF    (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_INFO   >(condition, instance, facility); }
inline auto CLOG_VERBOSE_IF (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_VERBOSE>(condition, instance, facility); }
inline auto CLOG_DEBUG_IF   (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_DEBUG  >(condition, instance, facility); }
inline auto CLOG_TRACE_IF   (bool condition, void* instance, int facility) { return gkr::log::stream_message_if<LOG_SEVERITY_TRACE  >(condition, instance, facility); }
...
template<typename... Args> void LOG    (                                int severity, int facility,                         std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts  (            LOG_INSTANCE, severity, facility,      std::move(fmt), std::forward<Args>(args)...); }
template<typename... Args> void LOG    (                                int severity, int facility, const std::locale& loc, std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts  (            LOG_INSTANCE, severity, facility, loc, std::move(fmt), std::forward<Args>(args)...); }
template<typename... Args> void LOG_IF (bool condition,                 int severity, int facility,                         std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts_if(condition, LOG_INSTANCE, severity, facility,      std::move(fmt), std::forward<Args>(args)...); }
template<typename... Args> void LOG_IF (bool condition,                 int severity, int facility, const std::locale& loc, std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts_if(condition, LOG_INSTANCE, severity, facility, loc, std::move(fmt), std::forward<Args>(args)...); }

template<typename... Args> void CLOG   (                void* instance, int severity, int facility,                         std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts   (               instance, severity, facility,      std::move(fmt), std::forward<Args>(args)...); }
template<typename... Args> void CLOG   (                void* instance, int severity, int facility, const std::locale& loc, std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts   (               instance, severity, facility, loc, std::move(fmt), std::forward<Args>(args)...); }
template<typename... Args> void CLOG_IF(bool condition, void* instance, int severity, int facility,                         std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts_if(condition,     instance, severity, facility,      std::move(fmt), std::forward<Args>(args)...); }
template<typename... Args> void CLOG_IF(bool condition, void* instance, int severity, int facility, const std::locale& loc, std::format_string<Args...> fmt, Args&&... args) { gkr::log::format_message_rts_if(condition,     instance, severity, facility, loc, std::move(fmt), std::forward<Args>(args)...); }
