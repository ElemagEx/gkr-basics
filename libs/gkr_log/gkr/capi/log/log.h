...
GKR_LOG_API int gkr_log_custom_message_start(void* channel, int severity, char** buf, unsigned* cch);
GKR_LOG_API int gkr_log_custom_message_cancel(void* channel);
GKR_LOG_API int gkr_log_custom_message_finish(void* channel, int severity, int facility);
GKR_LOG_API int gkr_log_custom_message_finish_ex(void* channel, const char* func, const char* file, unsigned line, int severity, int facility);
