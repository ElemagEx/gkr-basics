...
if(MSVC)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        set(CMAKE_CXX_FLAGS_WARNINGS "-Weverything -Wno-padded -Wno-alloca -Wno-weak-vtables ${CMAKE_CXX_FLAGS_EXCLUDE_CLANG_WARNINGS}")
    else()
        set(CMAKE_CXX_FLAGS_WARNINGS "-Wall -Wextra -Wpedantic -Wconversion -Wsign-conversion -Wshadow -Wunused")
    endif()
endif()
